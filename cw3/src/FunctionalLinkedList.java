...
public class FunctionalLinkedList extends LinkedList implements FunctionalList {
    ...
    public ReturnObject head(){
        if (head()== null) return new ReturnObjectImpl(ErrorMessage.EMPTY_STRUCTURE);
        else return new ReturnObjectImpl(get(0).getReturnValue());
    }
